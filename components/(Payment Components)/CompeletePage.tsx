...
const STATUS_CONTENT_MAP: Record<PaymentStatus, StatusContent> = {
  succeeded: {
...
const CompletePageComponent: React.FC = () => {
  ...
  return (
    <div id="payment-status">
      ...
      <h2 className="stripeH2" id="status-text">{STATUS_CONTENT_MAP[status].text}</h2>
      {intentId && (
